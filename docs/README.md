...
- [ ] Phase 3 — ambient product: **[x] 3a config file** ([`config-reference.md`](./config-reference.md)) · **[x] 3b trends/history** · **[x] 3c disk watcher** (`reclaim watch`) · **[x] 3e packaging** (pipx, LICENSE, demo, README) · TUI

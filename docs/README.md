...
- [x] Phase 3 — ambient product: **3a** config file ([`config-reference.md`](./config-reference.md)) · **3b** trends/history · **3c** disk watcher (`reclaim watch`) · **3d** live dashboard (`reclaim dashboard`) · **3e** packaging (pipx, LICENSE, demo, README)
